...
public class ScheduleRequest {
    ...
    public static int getLastID(Database db) {
        try {
            String sql = "SELECT LAST_INSERTED_ID() AS id;";
            int lastID = 0;
    ...
    public static int CreateScheduleRequest(ScheduleRequest sr, Database db) {
        int generatedKey = 0;
    ...
    public static void DeleteScheduleRequest(int id, Database db) {
    ...
    public static void UpdateScheduleRequest(ScheduleRequest sr, Database db) {
        try {
            ...
            int id = sr.id;
            PreparedStatement statement = db.conn.prepareStatement(query2);
    ...
    public static ArrayList<ScheduleRequest> RetrieveScheduleRequest(int id, Database db) {
